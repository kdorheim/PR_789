# Calculate the natural CH4 emissions and account for the heterotropic respiration.
#
...
# Run Hector
ini_file <- system.file(package = "hector", "input/hector_ssp245.ini")
...
# over write the natural ch4 emissions data frame since this is the final one.
write.csv(out,
...
if(FALSE){
    ...
    hc <- newcore(ini)
    setvar(hc, dates = natural_ch4_emissions$year, var = NATURAL_CH4(),
